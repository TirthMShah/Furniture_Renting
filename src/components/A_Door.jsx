...
export const A_Door = () => {
    ...
    > */}
                    ...
                    <div className="container-fluid p-0">
                        <img
                            src="image\Main_img\acrylic door title.png"
                            alt=""
                            className="d-block"
                            style={{ width: "100%" }}
                        />
