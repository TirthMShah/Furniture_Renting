...
export const MetallicChair = () => {
    ...
    > */}
                    ...
                    <div className="container-fluid p-0">
                        <img
                            src="image\Main_img\metallic chairs title.png"
                            alt=""
                            className="d-block"
                            style={{ width: "100%" }}
                        />
                        ...
                        <div className="row">
                            <div className="col-lg-3 col-md-6 col-xl-3 col-xxl-3 listProduct">
                                <div className="item" id={41}>
                                    <img
                                        src="image\MetallicChairs\MetallicChairs (1).jpg"
                                        alt=""
                                        className="img-fluid"
                                    />
                            ...
                            <div className="col-lg-3 col-md-6 col-xl-3 col-xxl-3 listProduct">
                                <div className="item" id={42}>
                                    <img
                                        src="image\MetallicChairs\MetallicChairs (2).jpg"
                                        alt=""
                                        className="img-fluid"
                                    />
                            ...
                            <div className="col-lg-3 col-md-6 col-xl-3 col-xxl-3 listProduct">
                                <div className="item" id={43}>
                                    <img
                                        src="image\MetallicChairs\MetallicChairs (3).jpg"
                                        alt=""
                                        className="img-fluid"
                                    />
                                    <span className="name">
                            ...
                            <div className="col-lg-3 col-md-6 col-xl-3 col-xxl-3 listProduct">
                                <div className="item" id={44}>
                                    <img
                                        src="image\MetallicChairs\MetallicChairs (4).jpg"
                                        alt=""
                                        className="img-fluid"
                                    />
                        ...
                        <div className="row my-5">
                            <div className="col-lg-3 col-md-6 col-xl-3 col-xxl-3 listProduct">
                                <div className="item" id={45}>
                                    <img
                                        src="image\MetallicChairs\MetallicChairs (5).jpg"
                                        alt=""
                                        className="img-fluid"
                                    />
                            ...
                            <div className="col-lg-3 col-md-6 col-xl-3 col-xxl-3 listProduct">
                                <div className="item" id={46}>
                                    <img
                                        src="image\MetallicChairs\MetallicChairs (6).jpg"
                                        alt=""
                                        className="img-fluid"
                                    />
                            ...
                            <div className="col-lg-3 col-md-6 col-xl-3 col-xxl-3 listProduct">
                                <div className="item" id={47}>
                                    <img
                                        src="image\MetallicChairs\MetallicChairs (7).jpg"
                                        alt=""
                                        className="img-fluid"
                                    />
                                    <span className="name">Cushy Cloud Wooden Fabric Stool</span>
                            ...
                            <div className="col-lg-3 col-md-6 col-xl-3 col-xxl-3 listProduct">
                                <div className="item" id={48}>
                                    <img
                                        src="image\MetallicChairs\MetallicChairs (8).jpg"
                                        alt=""
                                        className="img-fluid"
                                    />
                                    <span className="name">
                        ...
                        <div className="row my-5">
                            <div className="col-lg-3 col-md-6 col-xl-3 col-xxl-3 listProduct">
                                <div className="item" id={49}>
                                    <img
                                        src="image\MetallicChairs\MetallicChairs (9).jpg"
                                        alt=""
                                        className="img-fluid"
                                    />
                                    <span className="name">Velvet Vogue Sea Blue Wooden Stool</span>
                            ...
                            <div className="col-lg-3 col-md-6 col-xl-3 col-xxl-3 listProduct">
                                <div className="item" id={50}>
                                    <img
                                        src="image\MetallicChairs\MetallicChairs (10).jpg"
                                        alt=""
                                        className="img-fluid"
                                    />
                                    <span className="name">Fluffy Charm White Wooden Stool</span>
                            ...
                            <div className="col-lg-3 col-md-6 col-xl-3 col-xxl-3 listProduct">
                                <div className="item" id={51}>
                                    <img
                                        src="image\MetallicChairs\MetallicChairs (11).jpg"
                                        alt=""
                                        className="img-fluid"
                                    />
                                    <span className="name">Cushy Cloud Wooden Fabric Stool</span>
                            ...
                            <div className="col-lg-3 col-md-6 col-xl-3 col-xxl-3 listProduct">
                                <div className="item" id={52}>
                                    <img
                                        src="image\MetallicChairs\MetallicChairs (12).jpg"
                                        alt=""
                                        className="img-fluid"
                                    />
                                    <span className="name">
                        ...
                        <div className="row my-5">
                            <div className="col-lg-3 col-md-6 col-xl-3 col-xxl-3 listProduct">
                                <div className="item" id={53}>
                                    <img
                                        src="image\MetallicChairs\MetallicChairs (13).jpg"
                                        alt=""
                                        className="img-fluid"
                                    />
                            ...
                            <div className="col-lg-3 col-md-6 col-xl-3 col-xxl-3 listProduct">
                                <div className="item" id={54}>
                                    <img
                                        src="image\MetallicChairs\MetallicChairs (14).jpg"
                                        alt=""
                                        className="img-fluid"
                                    />
                            ...
                            <div className="col-lg-3 col-md-6 col-xl-3 col-xxl-3 listProduct">
                                <div className="item" id={55}>
                                    <img
                                        src="image\MetallicChairs\MetallicChairs (15).jpg"
                                        alt=""
                                        className="img-fluid"
                                    />
                            ...
                            <div className="col-lg-3 col-md-6 col-xl-3 col-xxl-3 listProduct">
                                <div className="item" id={56}>
                                    <img
                                        src="image\MetallicChairs\MetallicChairs (16).jpg"
                                        alt=""
                                        className="img-fluid"
                                    />
