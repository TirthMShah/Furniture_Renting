...
export const Sofa = () => {
    ...
    > */}
                    ...
                    <div className="container-fluid p-0">
                        <img
                            src="image\Main_img\sofa title.png"
                            alt=""
                            className="d-block"
                            style={{ width: "100%" }}
                        />
