...
export const Bed = () => {
    ...
    > */}
                    ...
                    <div className="container-fluid p-0">
                        <img
                            src="image\Main_img\bed title.png"
                            alt=""
                            className="d-block"
                            style={{ width: "100%" }}
                        />
