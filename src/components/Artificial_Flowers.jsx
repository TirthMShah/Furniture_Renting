...
export const Artificial_Flowers = () => {
  ...
  return (
                    ...
                    <nav className="navbar navbar-expand-xl navbar-light bg-light sticky-top d-flex">
                        <div className="container">
                            <div className="navbar-brand mx-5">
                                ...
                                >
                                    <img
                                        src="img/Home_Page-Images/hh 02.png"
                                        alt=""
                                        height="60px"
                                        width="130px"
                                    />
    ...
    <div className="container-fluid p-0">
      <img
        src="image/Artificial-flower-Images/Artificial-flower-main.webp"
        alt=""
        className="d-block"
        style={{ width: "100%" }}
      />
      ...
      <div className="row">
        <div className="col-lg-3 col-md-6 col-xl-3 col-xxl-3 listProduct">
          <div className="item" id={41}>
            <img
              src="image/Artificial-flower-Images/Artificial-flower-img- (1).jpg"
              alt=""
              className="img-fluid"
            />
        ...
        <div className="col-lg-3 col-md-6 col-xl-3 col-xxl-3 listProduct">
          <div className="item" id={42}>
            <img
              src="image/Artificial-flower-Images/Artificial-flower-img- (2).jpg"
              alt=""
              className="img-fluid"
            />
        ...
        <div className="col-lg-3 col-md-6 col-xl-3 col-xxl-3 listProduct">
          <div className="item" id={43}>
            <img
              src="image/Artificial-flower-Images/Artificial-flower-img- (3).jpg"
              alt=""
              className="img-fluid"
            />
            <span className="name">
        ...
        <div className="col-lg-3 col-md-6 col-xl-3 col-xxl-3 listProduct">
          <div className="item" id={44}>
            <img
              src="image/Artificial-flower-Images/Artificial-flower-img- (4).jpg"
              alt=""
              className="img-fluid"
            />
      ...
      <div className="row my-5">
        <div className="col-lg-3 col-md-6 col-xl-3 col-xxl-3 listProduct">
          <div className="item" id={45}>
            <img
              src="image/Artificial-flower-Images/Artificial-flower-img- (5).jpg"
              alt=""
              className="img-fluid"
            />
        ...
        <div className="col-lg-3 col-md-6 col-xl-3 col-xxl-3 listProduct">
          <div className="item" id={46}>
            <img
              src="image/Artificial-flower-Images/Artificial-flower-img- (6).jpg"
              alt=""
              className="img-fluid"
            />
        ...
        <div className="col-lg-3 col-md-6 col-xl-3 col-xxl-3 listProduct">
          <div className="item" id={47}>
            <img
              src="image/Artificial-flower-Images/Artificial-flower-img- (7).jpg"
              alt=""
              className="img-fluid"
            />
            <span className="name">Cushy Cloud Wooden Fabric Stool</span>
        ...
        <div className="col-lg-3 col-md-6 col-xl-3 col-xxl-3 listProduct">
          <div className="item" id={48}>
            <img
              src="image/Artificial-flower-Images/Artificial-flower-img- (8).jpg"
              alt=""
              className="img-fluid"
            />
            <span className="name">
      ...
      <div className="row my-5">
        <div className="col-lg-3 col-md-6 col-xl-3 col-xxl-3 listProduct">
          <div className="item" id={49}>
            <img
              src="image/Artificial-flower-Images/Artificial-flower-img- (9).jpg"
              alt=""
              className="img-fluid"
            />
            <span className="name">Velvet Vogue Sea Blue Wooden Stool</span>
        ...
        <div className="col-lg-3 col-md-6 col-xl-3 col-xxl-3 listProduct">
          <div className="item" id={50}>
            <img
              src="image/Artificial-flower-Images/Artificial-flower-img- (10).jpg"
              alt=""
              className="img-fluid"
            />
            <span className="name">Fluffy Charm White Wooden Stool</span>
        ...
        <div className="col-lg-3 col-md-6 col-xl-3 col-xxl-3 listProduct">
          <div className="item" id={51}>
            <img
              src="image/Artificial-flower-Images/Artificial-flower-img- (11).jpg"
              alt=""
              className="img-fluid"
            />
            <span className="name">Cushy Cloud Wooden Fabric Stool</span>
        ...
        <div className="col-lg-3 col-md-6 col-xl-3 col-xxl-3 listProduct">
          <div className="item" id={52}>
            <img
              src="image/Artificial-flower-Images/Artificial-flower-img- (12).jpg"
              alt=""
              className="img-fluid"
            />
            <span className="name">
        ...
        <div className="row my-5">
          <div className="col-lg-3 col-md-6 col-xl-3 col-xxl-3 listProduct">
            <div className="item" id={53}>
              <img
                src="image/Artificial-flower-Images/Artificial-flower-img- (13).jpg"
                alt=""
                className="img-fluid"
              />
          ...
          <div className="col-lg-3 col-md-6 col-xl-3 col-xxl-3 listProduct">
            <div className="item" id={54}>
              <img
                src="image/Artificial-flower-Images/Artificial-flower-img- (14).jpg"
                alt=""
                className="img-fluid"
              />
          ...
          <div className="col-lg-3 col-md-6 col-xl-3 col-xxl-3 listProduct">
            <div className="item" id={55}>
              <img
                src="image/Artificial-flower-Images/Artificial-flower-img- (15).jpg"
                alt=""
                className="img-fluid"
              />
          ...
          <div className="col-lg-3 col-md-6 col-xl-3 col-xxl-3 listProduct">
            <div className="item" id={56}>
              <img
                src="image/Artificial-flower-Images/Artificial-flower-img- (16).jpg"
                alt=""
                className="img-fluid"
              />
        ...
        <div className="row my-5">
          <div className="col-lg-3 col-md-6 col-xl-3 col-xxl-3 listProduct">
            <div className="item" id={57}>
              <img
                src="image/Artificial-flower-Images/Artificial-flower-img- (17).jpg"
                alt=""
                className="img-fluid"
              />
          ...
          <div className="col-lg-3 col-md-6 col-xl-3 col-xxl-3 listProduct">
            <div className="item" id={58}>
              <img
                src="image/Artificial-flower-Images/Artificial-flower-img- (18).jpg"
                alt=""
                className="img-fluid"
              />
              <span className="name">Luxe Loom Wooden Low Stool</span>
              <div className="my-5">
                <span />
              </div>
              <div className="my-1 text-center">
          ...
          <div className="col-lg-3 col-md-6 col-xl-3 col-xxl-3 listProduct">
            <div className="item" id={59}>
              <img
                src="image/Artificial-flower-Images/Artificial-flower-img- (19).jpg"
                alt=""
                className="img-fluid"
              />
              <span className="name">Wool Crafted Wooden Brown Seat</span>
              <div>
                <i
                  className="fas fa-star"
                  style={{ marginLeft: 2, color: "#f3c621" }}
              ...
              <div className="my-1 text-center">
                <span className="h4 mx-2">Rs. 8,299</span>
                <strike>Rs. 11,199</strike>
              </div>
              <button
                className="addcart-button"
                onclick="addCart(this.parentElement.id)"
          ...
          <div className="col-lg-3 col-md-6 col-xl-3 col-xxl-3 listProduct">
            <div className="item" id={60}>
              <img
                src="image/Artificial-flower-Images/Artificial-flower-img- (20).jpg"
                alt=""
                className="img-fluid"
              />
              <span className="name">Velvet Vogue White Wooden Stool</span>
              <div>
                <i
                  className="fas fa-star"
                  style={{ marginLeft: 2, color: "#f3c621" }}
              ...
              <div className="my-1 text-center">
                <span className="h4 mx-2">Rs. 12,399</span>
                <strike>Rs. 13,199</strike>
              </div>
              <button
                className="addcart-button"
                onclick="addCart(this.parentElement.id)"
